    ...
    <div style={pageStyle}>
      ...
      <div style={brandPanelStyle}>
        <div style={brandInnerStyle}>
          ...
          <h2 style={brandHeadlineStyle}>Sua agenda, sua equipe, seu crescimento.</h2>
          <p style={brandBodyStyle}>Gerencie serviços, pacotes e atendimentos em um só lugar — do agendamento ao relatório financeiro.</p>
          <ul style={featureListStyle}>
            {['Agenda unificada por banhista', 'Pacotes e créditos para tutores', 'Relatórios financeiros em tempo real', 'Auditoria completa de operações'].map((f) => (
      ...
      <div style={formPanelStyle}>
        <div style={formInnerStyle}>
          <h1 style={formTitleStyle}>Bem-vindo de volta</h1>
          <p style={formSubtitleStyle}>Acesse a área do pet shop</p>
          ...
          <form onSubmit={handleSubmit} style={{ marginTop: spacing.xl }}>
            <div style={{ marginBottom: spacing.md }}>
              ...
              <input
                ...
                required
                placeholder="seuemail@petshop.com.br"
                style={inputStyle}
              />
            </div>
